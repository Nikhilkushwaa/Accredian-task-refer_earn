          ...
          <div className="col-md-4">
            ...
            <ul className="footer-list">
              <li className="footer-list-item">
                <a href="mailto:admissions@accredian.com">Email us (For Data Science Queries)</a>
              </li>
              <li className="footer-list-item">
                <a href="mailto:pm@accredian.com">Email us (For Product Management Queries)</a>
              </li>
              <li className="footer-list-item">
              ...
              <li className="footer-list-item">Enrolled Student Helpline: +91 7969322507
<br></br>
      ...
      <div className="social-icons">
        ...
        <p className="footer-text">
              © 2024 Accredian A Brand of FullStack Education Pvt Ltd. All Rights Reserved Created by Nikhil kumar (Task)
            </p>
      </div>
